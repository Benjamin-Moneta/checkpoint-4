...
var ThemeContext = import_react12.default.createContext({});
var Consumer = ThemeContext.Consumer;
var Provider = ThemeContext.Provider;
function useBootstrapPrefix(prefix, defaultPrefix) {
  var prefixes = (0, import_react12.useContext)(ThemeContext);
...
var CarouselItem = import_react14.default.forwardRef(function(_ref, ref) {
...
function map(children, func) {
  ...
  return import_react15.default.Children.map(children, function(child) {
    return import_react15.default.isValidElement(child) ? func(child, index++) : child;
  });
}
...
var defaultProps = {
  ...
  wrap: true,
  touch: true,
  prevIcon: import_react17.default.createElement("span", {
    "aria-hidden": "true",
    className: "carousel-control-prev-icon"
  }),
  prevLabel: "Previous",
  nextIcon: import_react17.default.createElement("span", {
    "aria-hidden": "true",
...
function CarouselFunc(uncontrolledProps, ref) {
  ...
  var nextDirectionRef = (0, import_react17.useRef)(null);
  var _useState = (0, import_react17.useState)("next"), direction = _useState[0], setDirection = _useState[1];
  var _useState2 = (0, import_react17.useState)(false), paused = _useState2[0], setPaused = _useState2[1];
  var _useState3 = (0, import_react17.useState)(false), isSliding = _useState3[0], setIsSliding = _useState3[1];
  var _useState4 = (0, import_react17.useState)(activeIndex || 0), renderedActiveIndex = _useState4[0], setRenderedActiveIndex = _useState4[1];
  ...
  var prev = (0, import_react17.useCallback)(function(event) {
    if (isSliding) {
      return;
    }
  ...
  var handleEnter = (0, import_react17.useCallback)(function(node) {
    triggerBrowserReflow(node);
    if (onSlide) {
      onSlide(renderedActiveIndex, slideDirection);
    }
  }, [onSlide, renderedActiveIndex, slideDirection]);
  var handleEntered = (0, import_react17.useCallback)(function() {
    setIsSliding(false);
    if (onSlid) {
      onSlid(renderedActiveIndex, slideDirection);
    }
  ...
  var handleMouseOver = (0, import_react17.useCallback)(function(event) {
    if (pause === "hover") {
      setPaused(true);
    }
    if (onMouseOver) {
  ...
  var handleMouseOut = (0, import_react17.useCallback)(function(event) {
    setPaused(false);
    if (onMouseOut) {
      onMouseOut(event);
    }
  }, [onMouseOut]);
  var touchStartXRef = (0, import_react17.useRef)(0);
  var touchDeltaXRef = (0, import_react17.useRef)(0);
  var touchUnpauseTimeout = useTimeout();
  var handleTouchStart = (0, import_react17.useCallback)(function(event) {
  ...
  var handleTouchMove = (0, import_react17.useCallback)(function(event) {
  ...
  var handleTouchEnd = (0, import_react17.useCallback)(function(event) {
    if (touch) {
  ...
  var intervalHandleRef = (0, import_react17.useRef)();
  (0, import_react17.useEffect)(function() {
  ...
  var indicatorOnClicks = (0, import_react17.useMemo)(function() {
  ...
  return import_react17.default.createElement(Component, _extends({
  ...
  }), indicators && import_react17.default.createElement("ol", {
    ...
    return slide ? import_react17.default.createElement(Transition_default, {
      in: isActive,
    ...
    }) : import_react17.default.cloneElement(child, {
      className: (0, import_classnames3.default)(child.props.className, isActive && "active")
    });
  })), controls && import_react17.default.createElement(import_react17.default.Fragment, null, (wrap || activeIndex !== 0) && import_react17.default.createElement(SafeAnchor_default, {
    className: prefix + "-control-prev",
    onClick: prev
  }, prevIcon, prevLabel && import_react17.default.createElement("span", {
    className: "sr-only"
  }, prevLabel)), (wrap || activeIndex !== numChildren - 1) && import_react17.default.createElement(SafeAnchor_default, {
    className: prefix + "-control-next",
    onClick: next
  }, nextIcon, nextLabel && import_react17.default.createElement("span", {
    className: "sr-only"
  }, nextLabel))));
}
var Carousel = import_react17.default.forwardRef(CarouselFunc);
